    ...
    <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 min-h-screen flex">
      ...
      <main className="ml-64 flex-1 p-8">
        ...
        <header className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm">
              {isAccountant ? 'Review mode – view deductions and reports for this organization.' : `Welcome back, here's your tax status for ${currentMonth} ${currentYear}.`}
            </p>
          </div>
          {isAccountant && (
            <Link
        ...
        <div className="grid grid-cols-12 gap-6 auto-rows-[160px]">
          ...
          <div className="col-span-12 lg:col-span-8 row-span-2 bg-white dark:bg-slate-custom rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col overflow-hidden">
            <div className="p-6 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center">
          ...
          {/* YoY Summary Card */}
          <div className="col-span-12 lg:col-span-4 row-span-2 bg-slate-custom rounded-xl border border-slate-700 p-6 flex flex-col justify-between">
            <div>
