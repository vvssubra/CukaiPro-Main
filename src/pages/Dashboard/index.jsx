      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-12 gap-6 auto-rows-[160px]">
          ...
          <div
            ...
            className={`col-span-12 lg:col-span-4 row-span-1 bg-white dark:bg-slate-custom rounded-xl border-2 border-dashed flex flex-col items-center justify-center p-6 cursor-pointer transition-all duration-200 group focus:outline-none focus:ring-2 focus:ring-primary/50 animate-fade-in-up ${
              isUploading
